...
app_key = 'B1C1915196EBDAF501A9C66A19AB4432'
...
#Print a message indicating that the Raspberry Pi Pico will turn off thanks to Pico Nano Timer
print("---------------------------------------")
print("Activating Deep Sleep Mode to Conserve Power")
